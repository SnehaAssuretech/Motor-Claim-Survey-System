    ...
    <div class="container mt-4">        
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <span class="required">*</span>
                <asp:TextBox ID="txtClmPolRepNo" runat="server" CssClass="form-control" MaxLength="10" OnTextChanged="txtClmPolRepNo_TextChanged" />
        ...
        <div class="row justify-content-center">
            <div class="col-md-4 d-flex justify-content-center">
                ...
                <asp:Button ID="btnReject" runat="server" Text="Reject" CssClass="btn btn-danger mx-2" OnClick="btnReject_Click" Visible="false" />
