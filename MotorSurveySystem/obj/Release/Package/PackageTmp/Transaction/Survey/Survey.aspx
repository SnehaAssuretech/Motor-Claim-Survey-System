...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="heads">     
        ...
        <asp:Label ID="lblApprove" runat="server" Text="Survey Submitted" 
           ForeColor="Navy" Visible="False" 
           Style="text-align: right; padding-inline-end:130px; display: block; font-weight:bold" />
         <asp:Label ID="lblSurNo" runat="server" Text=""  Style="text-align: left; padding-inline-start:120px; display: block; font-weight:bold" ForeColor="Red"  />
    </div>
