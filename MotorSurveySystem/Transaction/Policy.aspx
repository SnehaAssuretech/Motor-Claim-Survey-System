    ...
    <div class="container mt-4">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <span class="required">*</span>
                <asp:TextBox ID="txtPolVehValue" runat="server" CssClass="form-control numberText" Style="text-align: right;" Placeholder="Enter Vehicle Value" onkeypress="validateNumericInput(event)" AutoPostBack="true" OnTextChanged="txtPolVehValue_TextChanged" MaxLength="12" />
        ...
        <%--  <Triggers>
            <asp:AsyncPostBackTrigger ControlID="ddlPolCurrCode" EventName="/>
            <asp:AsyncPostBackTrigger ControlID="txtGrossFCPrem" EventName="TextChanged" />
         </Triggers>
        ...
        <div class="row justify-content-center">
            <div class="col-md-4 d-flex justify-content-center">
                <!-- Use d-flex and justify-content-center -->
